...
def align_to_minute_boundary(dt: datetime, direction: str = 'down') -> datetime:
    """
...
def compute_data_volume_gb(nir_minutes: float = 0.0, 
                          vis_minutes: float = 0.0,
                          nir_rate_mbps: float = 2.74,
                          vis_rate_mbps: float = 0.88) -> float:
    """
...
def compute_slew_time_minutes(sep_deg: float, slew_rate_deg_per_min: float = 1.0) -> float:
    """
